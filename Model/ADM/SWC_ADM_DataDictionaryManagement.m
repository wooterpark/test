...
clear
close all
dictionaryName = 'SWC_ADM_DataDictionary.sldd';
...
%read signal sheet
[num,str,signal_str] = xlsread( 'SWC_ADM_DataDictionary', 'Signal') ;
signal_name = signal_str(2:end,1);
signal_row = signal_str(2:end,2);
signal_column = signal_str(2:end,3);
signal_description = signal_str(2:end,11);
signal_min = signal_str(2:end,4);
signal_max = signal_str(2:end,5);
signal_InitialValue = signal_str(2:end,6);
signal_unit = signal_str(2:end,7);
signal_datatype = signal_str(2:end,8);
signal_csc = signal_str(2:end,9);
signal_complexity = signal_str(2:end,10);
...
[num,str,parameter_str] = xlsread( 'SWC_ADM_DataDictionary','Parameter') ;
parameter_name = parameter_str(2:end,1);
parameter_description = parameter_str(2:end,8);
parameter_min  = parameter_str(2:end,3);
parameter_max  = parameter_str(2:end,4);
parameter_Value = parameter_str(2:end,2);
parameter_units = parameter_str(2:end,6);
parameter_datatypes = parameter_str(2:end,5);
parameter_csc = parameter_str(2:end,7);
parameter_headfile = parameter_str(2:end,9);
% parameter_Complexity = parameter_str(2:end,11);
...
%read simulik sheet
[num,str,AliasType_str] = xlsread( 'SWC_ADM_DataDictionary','simulink') ;
