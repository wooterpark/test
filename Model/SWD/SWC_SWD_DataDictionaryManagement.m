...
clear
close all
dictionaryName = 'SWC_SWD_DataDictionary.sldd';
...
%read signal sheet
[num,str,signal_str] = xlsread( 'SWC_SWD_DataDictionary', 'Signal') ;
...
[num,str,parameter_str] = xlsread( 'SWC_SWD_DataDictionary','Parameter') ;
...
%read simulik sheet
[num,str,AliasType_str] = xlsread( 'SWC_SWD_DataDictionary','BaseType') ;
