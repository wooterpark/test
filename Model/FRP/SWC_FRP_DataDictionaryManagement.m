...
clear
close all
dictionaryName = 'SWC_FRP_DataDictionary.sldd';
...
%read signal sheet
[num,str,signal_str] = xlsread( 'SWC_FRP_DataDictionary', 'Signal') ;
...
[num,str,parameter_str] = xlsread( 'SWC_FRP_DataDictionary','Parameter') ;
