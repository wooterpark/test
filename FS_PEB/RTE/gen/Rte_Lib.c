/** @file         Rte_Lib.c
  ...
  *
  *
  * Template:     Id: Rte_Lib_c.template 80895 2018-09-04 12:46:57Z BUA1YOK
  */
...
Rte_Start(void)                          /* [$Satisfies $SWS 2569] */
{
   ...
   /* [$Satisfies $SRD 79414] Periodic activation disabled ('task  as function' enabled) */
...
Rte_Stop(void)                           /* [$Satisfies $SWS 2570] */
{
   ...
   /* [$Satisfies $SRD 79414] Periodic activation cancel omitted ('task  as function' enabled) */
