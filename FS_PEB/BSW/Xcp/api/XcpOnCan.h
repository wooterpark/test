...
* Defines/Macros
***************************************************************************************************/
#define XCP_CAN_TL_TRANSMIT_BUFFER  XCP_TL_TRANSMIT_BUFFER
...
\return     -
***************************************************************************************************/
extern void Xcp_CanMainFunction(void);
...
***************************************************************************************************/
extern Xcp_ErrorCode Xcp_CanResumeModeData(Xcp_AdrPtr DaqRamPtr, Xcp_AdrPtrConst XcpDaqRamEndPtr, uint8 XcpTransportLayerId);
#endif
