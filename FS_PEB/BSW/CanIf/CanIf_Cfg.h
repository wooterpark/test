...
/* Range       :  STD_ON/STD_OFF                                          */
/**************************************************************************/
#define CANIF_PUBLIC_BUSOFF_RECOVERY_FROM_RXINDICATION        STD_ON
...
#define CANIF_NUM_CANRXPDUIDS                     16
...
#define CANIF_NUM_STATIC_CANTXPDUIDS                    17
...
#define CANIF_TOTAL_TXPDUS                  17


/*Total number of Rx-Pdus configured in CanIf*/
#define CANIF_TOTAL_RXPDUS                  16


/*Number of entries in CanIf_TxPduId_CustId_LUT[][]*/
#define CANIF_NUM_CUSTID_ENTRIES            17
...
#define CANIF_NUM_HRH_HANDLES                   16
...
#define CANIF_PUBLIC_TXCONFIRM_SUPPORT          STD_ON
...
typedef enum
{
    CANIF_Can_Network_0_CANNODE_0 = 0,
    CANIF_Can_Network_1_CANNODE_0 = 1
