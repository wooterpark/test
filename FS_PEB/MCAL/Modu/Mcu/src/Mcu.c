...
/*  TRACEABILITY : [cover parentID=DS_NAS_MCU_PR912_1,DS_MCAL_SWSC_MCU0401,
  ...
  SAS_NAS_ALL_PR630_PR631,SAS_NAS_ALL_PR1652, DS_MCAL_MCU_9004][/cover]
                                                                  */
/*******************************************************************************
**                      Includes                                              **
*******************************************************************************/
...
** Traceability    : [cover parentID=DS_AS_MCU101, DS_AS_MCU018,
   ...
   DS_AS_MCU_PR459,DS_MCAL_MCU_0404,DS_MCAL_MCU_9006][/cover]                 **
**                                                                            **
  ...
  #endif /* (MCU_DEV_ERROR_DETECT == STD_ON) || (MCU_SAFETY_ENABLE == STD_ON)*/
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* In case of a PLL loss-of-lock bit PLLSTAT.FINDIS is not set. i.e.,
...
** Traceability : [cover parentID=DS_AS_MCU101, DS_AS_MCU125,DS_AS_MCU146,
                  DS_AS_MCU125, DS_AS_MCU055, DS_AS_MCU143,
                  DS_AS_MCU144,DS_AS_MCU160,DS_MCAL_MCU_0409,
...
** Traceability : [cover parentID=DS_AS_MCU125,DS_NAS_MCU_PR2866_PR2867,
                   ...
                   DS_MCAL_MCU_0412, DS_MCAL_MCU_0413, DS_MCAL_MCU_9003]      **
**                                                                            **
...
/*******************************************************************************
** Traceability : [cover parentID=DS_MCAL_MCU_0419,
                  DS_MCAL_MCU_0420]                                           **
**                                                                            **
