...
/* Clear Mask for updating the register GTM_TIMi_AUX_IN_SRC */
#define GTM_TIM_CLRMSK_AUXIN_VAL_32 (0x000000FFUL)
...
#endif    
/* end of ((GTM_NO_OF_TIM_CH_CONF_NOTIF > 0U)  \
...
/* included the extern declaration of the debug variables in the 
 memory section GTM_SEC_VAR_32BIT based on Jira #0000051018-1288 */
#define GTM_START_SEC_VAR_32BIT
/*IFX_MISRA_RULE_19_01_STATUS=File inclusion after pre-processor directives is
 allowed only for MemMap.h*/
#include "MemMap.h"
...
#endif /* End of ifdef IFX_GTM_DEBUG */
...
** Traceability : [cover parentID=DS_NAS_GTM_PR1088,DS_NAS_GTM_PR1089,
  DS_NAS_GTM_PR1090,DS_NAS_GTM_PR1091,DS_NAS_HE2_GTM_PR3018]
  ...
  TomModuleUsage = (uint32)Gtm_kConfigPtr->GtmModuleConfigPtr->              \
    ...
    do
    {
      ...
      if(Gtm_lGetIntSource(IrqStatus, ChanIndex))
      {
        ...
        #endif /* GTM_NO_OF_TOM_CH_CONF_NOTIF > 0U */
...
void Gtm_IsrTimModule(uint8 ModuleNo, uint8 ChannelNumber)
{
  ...
  ModUsageChno = ((ModuleNo % GTM_TWO_U) == GTM_ONE_U )? \
    ...
    #else
      UNUSED_PARAMETER(NotifRegVal)
    #endif /* GTM_NO_OF_TIM_CH_CONF_NOTIF > 0U */
...
#endif /* end of defined(GTM_NO_OF_ATOM_PRIMARY_CONF_NOTIF) */
    ...
    for(MinorCnt = GTM_ZERO_U; (MinorCnt < GTM_BITS_IN_U32); MinorCnt++)
    {
     ...
     PBConfigStructure and is within allowed range.*/
        ...
        GTM_SFR_INIT_USER_MODE_WRITE32((TimChannelRegPtr->CH_EIRQ_EN.U)  , \
          ...
          /* Based on Jira #0000051018-698, the macro 
          GTM_SFR_INIT_USER_MODE_WRITE32 is replaced by 
          GTM_SFR_INIT_USER_MODE_MODIFY32 for updating the 
          GTM_TIMi_AUX_IN_SRC */
          /*Setting TIM AUX_IN values*/
           GTM_SFR_INIT_USER_MODE_MODIFY32(\
            (MODULE_GTM.TIM_AUX_IN_SRC[ModuleNo].U),\
             GTM_TIM_CLRMSK_AUXIN_VAL_32,\
              ((uint32)TimConfigPtr->TimAuxInSrcSel\
                                   & GTM_TIM_CLRMSK_AUXIN_VAL_32))           
...
/*******************************************************************************
** Traceability : [cover parentID=DS_MCAL_GTM_0006,
DS_MCAL_GTM_0011,DS_MCAL_GTM_0010,DS_MCAL_GTM_9000]                           **
**                                                                            **
