...
#define GTM_SFR_INIT_SETSAFETYENDINIT_TIMED()                                \
 ...
 initialiser*/
  ...
  { uint32 val ; (val) = (reg); (val) &= (clearmask); (val) |= (setmask);  \
                                                                (reg) = (val);}
#endif /* GTM_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON  */
#else
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
...
typedef struct
{
  ...
  #endif /* GTM_NO_OF_ATOM_SECONDARY_CONF_NOTIF */
...
typedef struct
{
  ...
  #endif /* GTM_NO_OF_ATOM_CH_CONF_NOTIF > 0U */

}Gtm_NotificationConfigType;

#endif /* GTM_MOD_CH_CONFIGURED */
...
*******************************************************************************/
/* The extern declaration of Gpt_Isr has been moved from source file to
   header file as per the coding standard */
...
#endif /* GTM_GPT_MODULE_USED == STD_ON */

/* The extern declaration of Pwm_17_Gtm_Isr has been moved from source file to 
   header file as per the coding standard */
...
#endif /* GTM_PWM_MODULE_USED == STD_ON */

/* The extern declaration of Icu_17_GtmCcu6_Eru_Isr has been moved from source
   file to header file as per the coding standard */
...
#endif /* GTM_ICU_MODULE_USED == STD_ON */
...
#endif /* GTM_DEINIT_API_ENABLE == STD_ON */
...
** Syntax : IFX_INLINE uint32 Gtm_GetTomTimerRegisters(                       **
...
** Syntax : IFX_INLINE void Gtm_ModifyOutputCtrl (uint8 TimerModule,          **
**                    uint8 ModuleNo, uint8 ChannelNo, boolean ToEnable)      **
** [/cover]                                                                   **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
...
** Return value:     None                                                     **
**                                                                            **
** Description :   This service enables/disables the TOM/ATOM Channel output. **
*******************************************************************************/
_IFXEXTERN_ IFX_INLINE void Gtm_ModifyOutputCtrl (uint8 TimerModule, 
                              uint8 ModuleNo, uint8 ChannelNo, boolean ToEnable)
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for IFX_INLINE functions
    defined in header files*/
{
...
** Syntax : IFX_INLINE Gtm_AruReqStatusType Gtm_CtrlAruFrame(uint16           **
**                AruAddress, uint8 ReqType, uint32* AruFrame, uint8 ReadReq) **
** [/cover]                                                                   **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
...
**                   ARU frames                                               **
*******************************************************************************/
_IFXEXTERN_ IFX_INLINE Gtm_AruReqStatusType Gtm_CtrlAruFrame(uint16 AruAddress, 
