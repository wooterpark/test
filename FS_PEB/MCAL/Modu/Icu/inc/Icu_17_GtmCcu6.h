...
/* EdgeCount maximum value, supported by EnableMultiEdgeDetection API. 
   CNTS bits of TIM0_CHx_CNTS register can have the max value as 2^24 -1. 
   That is 16777215 or 0xFFFFFF. The value (EdgeCount-1) is written to 
   the CNTS filed so that the interrupt will be raised when number of 
   received edges equals EdgeCount. The max value of the parameter 
   EdgeCount is 0x01000000. This is introduced as part of Jira fix 
   0000051018-496 */
#define ICU_EDGE_COUNT_MAX_VALUE  (0x01000000UL)
