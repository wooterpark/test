...
**                                                                           **
**  $CC VERSION : \main\dev_tc23x_as4.0.3\34 $                               **
**                                                                           **
**  $DATE       : 2018-01-22 $                                               **
**                                                                           **
...
/* Identifier types of Priority class of Tx MO */

/* Tx acceptance filtering is based on the list order */
#define CAN_PRI_1 ((Can_TxObjPriorityClassType)1
/* Tx acceptance filtering is based on the CAN identifier */
#define CAN_PRI_2 ((Can_TxObjPriorityClassType)2)
/* Tx acceptance filtering is based on the list order */
#define CAN_PRI_3 ((Can_TxObjPriorityClassType)3)
...
/* Type to reperesent priority class of the Tx MO */
typedef uint32 Can_TxObjPriorityClassType;

#if (CAN_LPDU_RX_CALLOUT == STD_ON)
/* Type for Receive L-PDU callout function */
typedef boolean (*Can_LPduRxCalloutFnPtrType)(Can_HwHandleType Hrh,
                                              Can_IdType CanId,
                                              uint8 CanDlc,
...
typedef struct Can_TxHwObjectConfigType
{
  ...
  #endif
  /* Priority class of the Tx MO */
  Can_TxObjPriorityClassType TxObjPriorityClass;
...
typedef struct Can_17_MCanP_ConfigType
{
  ...
  /* Pointer to Configuration of Hrh Mapping */
   const uint16 *CanRxObjectHrhKer0MapPtr;
  #endif


  #if (CAN_RX_OBJECT_KER1 > 0U)
  /* Pointer to Configuration of Hrh Mapping */
   const uint16 *CanRxObjectHrhKer1MapPtr;
  #endif
