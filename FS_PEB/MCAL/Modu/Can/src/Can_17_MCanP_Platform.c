...
**                                                                           **
**  $CC VERSION : \main\dev_tc29xbc_as4.0.3\dev_tc29xbc_as4.0.3_kernel0\7 $  **
**                                                                           **
**  $DATE       : 2017-10-05 $                                               **
**                                                                           **
...
** TRACEABILITY: [cover parentID=]                                            **
**                                                                            **
** Syntax           :  uint16 Can_lGetHthIndex                                **
**                                            (                               **
**                                              uint8 KerIdx,                 **
**                                              uint16 TxMOIdx                **
**                                            )                               **
...
**                    TxMOIdx - Starting value of HwObjectId                  **
** Parameters (out) : None                                                    **
**                                                                            **
** Return value     : TxHandleIdx                                             **
**                                                                            **
** Description      : Getting HTH index                                       **
**                                                                            **
*******************************************************************************/
uint16 Can_lGetHthIndex(uint8 KerIdx, uint16 TxMOIdx)
{
  uint16 TxHandleIdx = CAN_ZERO;
  #if (CAN_TX_OBJECT_KER0 > CAN_ZERO)
  /* Calculate the HTH Id mapped to corresponding HW Object ID */
  /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic used due to
  PBConfigStructure and is within allowed range.*/
    TxHandleIdx = Can_kConfigPtr->CanTxObjectHthKer0MapPtr[TxMOIdx];
  #endif
  #if((CAN_TX_OBJECT_KER0 < CAN_ONE))
  UNUSED_PARAMETER(TxMOIdx)
  #endif
...
** TRACEABILITY: [cover parentID=]                                            **
**                                                                            **
** Syntax           :  uint16 Can_lGetHrhIndex                                **
**                                               (                            **
**                                                 uint8 KerIdx,              **
**                                                 uint16 HrhOffset           **
**                                               )                            **
...
**                                                                            **
*******************************************************************************/
uint16 Can_lGetHrhIndex(uint8 KerIdx, uint16 HrhOffset)
{
  uint16 Hrh = CAN_ZERO;
