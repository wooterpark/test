...
/* U1_V2_CUR_Group Group notification function declartion */
extern void U1_V2_AdcNotification(void);
/* AdcGroup_1 Group notification function declartion */
extern void AdcGroup1_Notification(void);
/* AdcGroup_2 Group notification function declartion */
extern void AdcGroup2_Notification(void);
/* AdcGroup_3 Group notification function declartion */
extern void AdcGroup3_Notification(void);
/* AdcGroup_4 Group notification function declartion */
extern void AdcGroup4_Notification(void);
/* AdcGroup_5 Group notification function declartion */
...
static const Adc_ChannelCfgType Adc_kKernel0ChCfg0[]=
{
 ...
 {
  /* AI_U1_CUR_Channel  configuration */
  Adc_lConfigChannel(
 ...
 {
  /* AI_V2_CUR_Channel  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x2U)
...
static const Adc_ChannelCfgType Adc_kKernel1ChCfg0[]=
{
 ...
 {
  /* AI_V1_CUR_Channel  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x8U)
 ...
 {
  /* AI_W2_CUR_Channel  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0xaU)
...
static const Adc_ChannelCfgType Adc_kKernel2ChCfg0[]=
{
 ...
 {
  /* AI_W1_CUR_Channel  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x10U)
 ...
 {
  /* AI_U2_CUR_Channel  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x12U)
...
static const Adc_ChannelCfgType Adc_kKernel4ChCfg0[]=
{
 ...
 {
  /* EPP_AdcG4_Channel_IS  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x25U)
 ...
 {
  /* EPP_AdcG4_Channel_POS1  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x26U)
 ...
 {
  /* EPP_AdcG4_Channel_POS2  configuration */
  Adc_lConfigChannel(
                      ADC_REF_VOLTAGE_VAREF,
                      (0U),
                      (0x27U)
...
static const Adc_GroupDefType Adc_kCfg0Kernel0AdcGroup_UBR[]=
{  
  1U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel0U1_V2_CUR_Group[]=
{  
  3U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel1V1_W2_CUR_Group[]=
{  
  3U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel1AdcGroup_1[]=
{  
  4U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel2W1_U2_CUR_Group[]=
{  
  3U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel2AdcGroup_2[]=
{  
  5U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel3AdcGroup_18VHS[]=
{  
  1U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel3AdcGroup_Sin[]=
{  
  2U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel3AdcGroup_3[]=
{  
  6U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel4AdcGroup_SBC[]=
{  
  1U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel4EPP_AdcGroup[]=
{  
  3U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel4AdcGroup_4[]=
{  
  4U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel5AdcGroup_18VLS[]=
{  
  1U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel5AdcGroup_Cos[]=
{  
  2U,
...
static const Adc_GroupDefType Adc_kCfg0Kernel5AdcGroup_5[]=
{  
  6U,
...
{
  {
    ...
    &Adc_kCfg0Kernel0AdcGroup_UBR[0U],
  ...
  },/*AdcGroup_UBR*/ 
  {
    ...
    #if (ADC_GRP_NOTIF_CAPABILITY == STD_ON)
    /* ADC079: ADC081: ADC084: ADC085: ADC104: Notification function pointer */
    &U1_V2_AdcNotification,
    #endif /* (ADC_GRP_NOTIF_CAPABILITY == STD_ON) */

    /* Assignment of channels to a channel group */
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel0U1_V2_CUR_Group[0U],
...
{
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel1V1_W2_CUR_Group[0U],
...
{
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel2W1_U2_CUR_Group[0U],
...
{
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel3AdcGroup_18VHS[0U],
  ...
  },/*AdcGroup_18VHS*/ 
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel3AdcGroup_Sin[0U],
...
{
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel4AdcGroup_SBC[0U],
  ...
  },/*AdcGroup_SBC*/ 
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel4EPP_AdcGroup[0U],
  ...
  },/*EPP_AdcGroup*/
  {
    ...
    #if (ADC_GRP_NOTIF_CAPABILITY == STD_ON)
    /* ADC079: ADC081: ADC084: ADC085: ADC104: Notification function pointer */
    &AdcGroup4_Notification,
    #endif /* (ADC_GRP_NOTIF_CAPABILITY == STD_ON) */

    /* Assignment of channels to a channel group */
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel4AdcGroup_4[0U],
...
{
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel5AdcGroup_18VLS[0U],
  ...
  },/*AdcGroup_18VLS*/ 
  {
    ...
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel5AdcGroup_Cos[0U],
  ...
  },/*AdcGroup_Cos*/
  {
    ...
    #if (ADC_GRP_NOTIF_CAPABILITY == STD_ON)
    /* ADC079: ADC081: ADC084: ADC085: ADC104: Notification function pointer */
    &AdcGroup5_Notification,
    #endif /* (ADC_GRP_NOTIF_CAPABILITY == STD_ON) */

    /* Assignment of channels to a channel group */
    /* First element is the number of configured channels in the group */
    /* From Second element will give the channel ID */
    &Adc_kCfg0Kernel5AdcGroup_5[0U],
