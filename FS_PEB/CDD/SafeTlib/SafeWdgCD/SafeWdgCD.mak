...
SAFEWDG_OBJDIR = $(APPL_BASE_DIR)/debug/TC$(STL_TARGET)x/gnu
...
$(SAFEWDG_OBJDIR)/SafeWdgQspi_PBCfg.o: $(CONFIG_DIR)/src/SafeWdgQspi_PBCfg.c
	...
	@$(CCTC) -o $(SAFEWDG_OBJDIR)/SafeWdgQspi_PBCfg.o $(STD_OPT_SWDG) $(CONFIG_DIR)/src/SafeWdgQspi_PBCfg.c  -I$(SWDGM_BASE_DIR)"./UpperLayer/SafeWdgM/inc"
