...
*******************************************************************************/
const uint32 Prv_StartUp_Flash0AppFlag_u32 __attribute__ ((asection(".FLASH0_APP_INTEG_FLAG", "f=a"))) = 0x5A5A5A5AUL;
...
const BMD_HDR Bmiheader_0 =
{
  ...
  0x00000000,
  0x00000000,
  0x49E9B5B4,//0x49E9B5B4,
  0xB6164A4B//0xB6164A4B
};
#pragma section
...
#endif
{
  ...
  if(CoreNumber == 0) {
	  ...
	  for(loop=0x70000000;loop<0x7001BFFF;loop++)
	  {
		  *loop=0;
